...
public class FileOutputStream_Ex1 {
	...
	public static void main(String[] args) {
		...
		try {
			//	1. 객체(인스턴스) 생성 - 해당 파일이 만들어짐
			//fos = new FileOutputStream(file); //파일 내용 삭제후 쓰기
			
			//	 new FileOutputStream(file, append);
			fos = new FileOutputStream(file, true); //apend처리 되서 기존 내용삭제 x 추가됨
...
//			
			...
			fos.write(bytes,6,7); //6번부터 7개의 문자열 추출
			fos.write('\n');
