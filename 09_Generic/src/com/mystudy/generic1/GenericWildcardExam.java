...
public class GenericWildcardExam {
	...
	public static void main(String[] args) {
		...
		// 2. <? extends 자료형> : 자료형 포함, 상속받은 자녀(sub) 클래스만 
		//    API : <? extends E>
		...
		// <? extends 자료형> : 자료형 포함 , sub 타입 extends 한 타입만 가능
		...
		// box10 = new BoxT<Character>(); //타입 미스매치 number 자식관계 x
		
		// box10 = new BoxT<Object>(); // 상속관계 Number 자녀타입(sub)가 아님
		...
		//box20 = new BoxT<Integer>(); //타입 미스매치 부모(super)타입이 아님
